    ...
    <el-main class="container-sub-page-main">
      <div class="sub-page-content">
        ...
        <el-dialog v-model="dialogResetPasswordForm" title="重置密码" width="550">
          <el-form :model="passwordForm" :rules="passwordRules"  ref="passwordRuleFormRef">
            ...
            <el-form-item prop="newPassword" label="密码" label-width="90px" style="margin-right: 50px;" required >
            ...
            <el-form-item prop="againPassword" label="确认密码" label-width="90px" style="margin-right: 140px;" required >
